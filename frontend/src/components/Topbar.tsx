        ...
        <div className="h-12 bg-white dark:bg-slate-900 border-b dark:border-slate-800 flex items-center justify-between px-3 md:px-6 shrink-0 z-[60] transition-colors duration-200">
            ...
            <div className="flex items-center space-x-2 md:space-x-3">
                <button
                    ...
                    className="p-1.5 rounded-lg bg-slate-100 dark:bg-slate-800 text-slate-500 dark:text-slate-400 hover:bg-slate-200 dark:hover:bg-slate-700 transition-colors touch-target"
